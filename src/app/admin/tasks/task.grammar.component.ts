    ...
    <div style="max-width: 800px; margin: auto; text-align:center">
      <div class="panel panel-default">
        <div class="form-group">
          ...
          <input style="width: 20%" placeholder="Please, enter a name" [(ngModel)]="taskName">
        </div>
        <div class="form-group">
          <label>Type the theme of a new grammar task: &nbsp;</label>
          <input style="width: 20%" placeholder="Please, enter a theme" [(ngModel)]="text">
        </div>
        <div class="form-group">
...
export class TaskGrammarComponent implements OnInit {
  ...
  POST = '/questions-text/create-grammar';
  ...
  submit(): void {
    ...
    const t = new Task(this.taskName, this.text, this.readyQuestions, this.reward, this.minCost, localStorage.getItem('id'));
